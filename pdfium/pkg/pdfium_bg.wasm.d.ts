...
export function pdfiumwasmdocument_page_size(a: number, b: number, c: number): void;
export function pdfiumwasmdocument_render_page(a: number, b: number, c: number, d: number, e: number): void;
export function __wbg_pdfiumwasmpagesize_free(a: number): void;
export function __wbg_get_pdfiumwasmpagesize_width(a: number): number;
export function __wbg_set_pdfiumwasmpagesize_width(a: number, b: number): void;
export function __wbg_get_pdfiumwasmpagesize_height(a: number): number;
export function __wbg_set_pdfiumwasmpagesize_height(a: number, b: number): void;
